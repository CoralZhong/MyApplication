...
public class Download extends BaseActivity {
         ...
         protected void initContentView(Bundle savedInstanceState) {
                 ...
                 if(u.equals("")){
                         Toast.makeText(Download.this, "地址不能为空~", Toast.LENGTH_SHORT).show();
                     }else if(name.equals("")){
                         Toast.makeText(Download.this, "文件名不能为空~", Toast.LENGTH_SHORT).show();
                     }else{
                         ...
                         try {
                                 ...
                                 Toast.makeText(Download.this, "这个URL不合法！", Toast.LENGTH_SHORT).show();
                             }
        ...
        @Override
                 protected void onPostExecute(String s) {
                         pd.dismiss();
                         Toast.makeText(Download.this, "完成", Toast.LENGTH_SHORT).show();
                         Intent i=new Intent();
                         ...
                         try {
                                 ...
                                 Toast.makeText(Download.this, "没有对应的打开程序", Toast.LENGTH_SHORT).show();
                             }
